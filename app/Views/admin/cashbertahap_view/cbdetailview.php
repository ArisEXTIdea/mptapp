        ...
        <div class="col-12 col-sm-8 col-md-9 col-lg-10 p-3 content-bg content-container" id='content'>
            <div class="container-fluid p-4 m-0 item-bg">
                <div class="row">
                    ...
                    <?php endif;?>
                    <!-- --------------------------------- -->
                        <h3>Detail Tagihan Cash Bertahap</h3>
                    </div>
                </div>
                <!-- Users Tabele -->
                <div class="row">
                                ...
                                <?php foreach($data as $d):?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/admin/bayar-tagihan-cash-bertahap/<?= $d['id_pembayaran'] ?>" class="btn btn-primary main-bg m-1">Bayar</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                            ...
                            <tbody>
                                ...
                                <?php foreach($dataTolak as $d):?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/admin/bayar-tagihan-cash-bertahap/<?= $d['id_pembayaran'] ?>" class="btn btn-primary main-bg m-1">Bayar Ulang</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                            ...
                            <tbody>
                                ...
                                <?php foreach($datalunas as $d):?>
                                    <tr>
                                        ...
                                        <td class="display-md-none"><?= $d['status_pembayaran'] ?></td>
                                        <td class="text-center">
                                            <a href="/admin/detail-pembayaran-cash-bertahap/<?= $d['id_pembayaran']?>" class="btn btn-primary main-bg m-1">Lihat</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
