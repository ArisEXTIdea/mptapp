                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <div>
                                <form class="d-flex" action="/admincontroller/cariCtData" method="get">
                                    <div class="form-group mx-2">
                                        <input type="text" class="form-control" placeholder="Tulis nama pembeli disisni" id="user-search" name="searchKey">
                                    </div>
                                    <div>
                        ...
                        <table class="table table-striped">
                            <thead class='main-bg'>
                                <tr>
                                    ...
                                    <th scope="col" class="user-email text-center display-sm-none" >Set KPR</th>
                                ...
                                <?php foreach($data as $d):?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if($d['cash_tunai_set_status'] == 1):?>
                                            <a href="/admin/cash-tunai-detail/<?= implode('-' ,explode(' ', $d['id_cash_tunai']))?>" class="btn btn-primary main-bg m-1">Detail</a>
                                            <?php endif;?>
                                            <?php if($d['cash_tunai_set_status'] == 0):?>
                                            <a href="/admin/atur-cash-tunai/<?= $d['id_pesanan']?>" class="btn btn-danger m-1">Atur</a>
                                            <?php endif;?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
    ...
    <script>
        ...
        const downloadData = () => {
            $(document).ready(function () {
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url().'/AdminController/getPesananCtDatatoDownload'?>",
                    dataType: "json",
        ...
        const saveAsExcel = (buffer, fileName) => {
            ...
            saveAs(data, 'Cash_tunai' + fileName+'_export_'+new Date().getTime()+EXCEL_EXTENSION)
        }
