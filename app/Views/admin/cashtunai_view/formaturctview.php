        ...
        <div class="col-12 col-sm-8 col-md-9 col-lg-10 p-3 content-bg content-container" id='content'>
            <div class="container-fluid p-4 m-0 item-bg">
                <div class="row">
                    ...
                    <?php endif;?>
                    <!-- --------------------------------- -->
                        <h3>Atur Cash Bertahap</h3>
                    </div>
                    <div class="row jsutify-content-center">
                        <div class="col-10">    
                            <form action="/admincontroller/simpanPengaturanCt">
                                <?= csrf_field() ?>
                                <?php 
                                ...
                                <div class="form-group my-2 d-none">
                                    <label for="id_pesanan " class="my-2">Id Pesanan</label>
                                    <input type="text" name="id_pesanan" value="<?= $idPesanan?>" class="form-control">
                                </div>
                                <div class="form-group my-2 d-none">">
                                    <label for="uang_muka " class ="my-2">Uang Muka</label>
                                    <input type="number" name="uang_muka" class="form-control" value="0">
                                </div>
                                <div class="form-group my-2 d-none">
                                    <label for="jumlah_bunga " class="my-2">Jumlah Bunga(%)</label>
                                    <input type="number" name="jumlah_bunga" class="form-control" value="0">
                                </div>
                                <div class="form-group my-2 d-none">">
                                    <label for="lama_bulanan " class="my-2">Jangka Waktu Cash Bertahap(Bulan)</label>
                                    <input type="number" name="lama_bulanan" class="form-control"  value="1">
                                </div>
                                <div class="form-group my-2">
                                    <label for="bayar_bulanan " class="my-2">Jumlah Pembayaran</label>
                                    <input type="number" name="bayar_bulanan" class="form-control">
                                </div>
                                <div class="my-3">
                                    <button type="submit" class="btn btn-primary main-bg">Simpan Pembayaran</button>
                                </div>
                            </form>
                        </div>
                    </div>
