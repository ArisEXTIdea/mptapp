            ...
            <div class="container-fluid p-4 m-0 item-bg">
                <div class="row">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="/admin/cash-tunai-detail/<?= $data['id_metode_pembayaran']?>" class="btn btn-warning d-flex align-items-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="/admincontroller/updatepembayaranct" enctype="multipart/form-data" method="post">
                            <?= csrf_field() ?>
