            ...
            <div class="container-fluid p-4 m-0 item-bg">
                <div class="row">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="/admin/riwayat-pesanan" class="btn btn-warning d-flex align-items-center">
                ...
                <div class="row">
                    <div class="col-12 p-3">
                        <a href="#" class="btn btn-success" onclick="downloadAsExcel()" id="detailPesanan">
