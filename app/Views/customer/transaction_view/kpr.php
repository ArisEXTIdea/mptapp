            ...
            <div class="row product-container justify-content-center p-3">
                ...
                <div class="col-12 col-md-7 col-lg-8 w-bg m-2 p-5">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <h3 class="mb-4">Transaksi Saya KPR</h3>
                                ...
                                <?php foreach($data as $d):?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/customer/bayar-tagihan-kpr/<?= $d['id_pembayaran'] ?>" class="btn btn-primary main-bg m-1">Bayar</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                            ...
                            <tbody>
                                ...
                                <?php foreach($dataTolak as $d):?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/customer/bayar-ulang-tagihan-kpr/<?= $d['id_pembayaran'] ?>" class="btn btn-primary main-bg m-1">Bayar Ulang</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
