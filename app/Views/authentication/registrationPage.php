    ...
    <div class="row p-0 m-0">
        <div class="col-12 col-sm-7 col-md-5 reg-form border p-5">
            ...
            <div class="reg-info my-5">
                ...
                <p>Daftar mudah dan simpel untuk mendapatkan rumah impian anda</p>
            </div>
            <div class="reg-form">
                <form action="/AuthenticationController/saveUserToDatabase" method='post'>
                    <div class="form-group mt-3">
                        <label for="full_name">Nama Lengkap</label>
                        <input type="text" name="fullname" placeholder="Masukkan nama lengkap anda" class='form-control mt-1' id="fullname" required>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <div class="form-group mt-3">
                        <label for="password-ulangi">Ulangi Password</label>
                        <input type="password" name="password-ulangi" placeholder="Ulangi Password Anda" class='form-control mt-1 ' id='password-input-verify' required>
                    </div>
                    <div class="form-check mt-3">
                        <input class="form-check-input" type="checkbox" value="" id="defaultCheck1" required>
                        <label class="form-check-label" for="defaultCheck1">
                            Saya setuju dengan persyaratan dan ketentuan oleh PT. Maestro Putra Timur
                        </label>
                    </div>
                    <div class="form-group mt-3">
                        <button class="btn btn-block btn-primary btn-register" disabled>Daftar Sekarang</button>
                    </div>
